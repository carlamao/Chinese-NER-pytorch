...
if __name__ == '__main__':
    ...
    path_train_val = 'resume/demo.train.char'
    path_dev = 'resume/demo.dev.char'
    path_test = 'resume/demo.test.char'
    ...
    save_dataset(train_dataset, 'resume/train')
    save_dataset(val_dataset, 'resume/val')
    save_dataset(test_dataset, 'resume/test')

    # Build tags from dataset
    build_tags('resume', 'resume/tags.txt')
