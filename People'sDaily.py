...
if __name__ == '__main__':
    ...
    path_train_val = 'PeoplesDaily/example.train'
    path_dev = 'PeoplesDaily/example.dev'
    path_test = 'PeoplesDaily/example.test'
    ...
    save_dataset(train_dataset, 'PeoplesDaily/train')
    save_dataset(val_dataset, 'PeoplesDaily/val')
    save_dataset(test_dataset, 'PeoplesDaily/test')

    # Build tags from dataset
    build_tags('PeoplesDaily', 'PeoplesDaily/tags.txt')
