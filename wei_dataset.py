...
if __name__ == '__main__':
    ...
    path_train_val = 'wei/weiboNER.conll.train.txt'
    path_dev = 'wei/weiboNER.conll.dev.txt'
    path_test = 'wei/weiboNER.conll.test.txt'
    ...
    save_dataset(train_dataset, 'wei/train')
    save_dataset(val_dataset, 'wei/val')
    save_dataset(test_dataset, 'wei/test')

    # Build tags from dataset
    build_tags('wei', 'wei/tags.txt')
